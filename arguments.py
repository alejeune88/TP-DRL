...
def get_args():
    ...
    # environment setting
    parser.add_argument('--env_name', type=str, default='CartPole-v0', help='the environment name')
    ...
    parser.add_argument('--team_name', type=str, default='Lejeune', help='team name')
